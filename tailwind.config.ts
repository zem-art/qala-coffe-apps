  ...
  theme: {
    extend: {
      colors: {
        ...
        'text-accent' : '#14171A',
        'text-background' : '#F5F8FA',
        'text-white' : '#FFFFFF',
        'text-black' : '#000000',
        'text-gray' : '#657786',
        'text-gray-light' : '#AAB8C2',
        'text-gray-dark' : '#E1E8ED',
        'text-gray-darker' : '#F5F8FA',
        'text-gray-darkest' : '#F5F8FA',
        'text-gray-lightest' : '#F5F8FA',
        'text-gray-lighter' : '#F5F8FA',
        'text-yellow-500' : '#FFCC00',
      },
      borderRadius: {
