    ...
    return (
      <div className="p-4 md:p-6 lg:p-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Daftar Reservasi</h2>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Kelola data reservasi pelanggan kafe Anda di sini.</p>
          </div>
        </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 border-b border-gray-50 dark:border-gray-800">
                        <div className="flex gap-2">
                          <button 
                            onClick={() => router.push(`/admin/booking/${dtx.id}`)} 
                            className="p-2 text-gray-400 hover:text-sky-600 hover:bg-sky-50 dark:hover:bg-sky-900/30 rounded-lg transition-colors cursor-pointer" 
                            title="Detail/Edit Reservasi"
                          >
